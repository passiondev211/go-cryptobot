...
export default class WinAnimation extends Component {
  render() {
    return (
      <div className="bet-win bet-container">
        <div className="hidden-container">
          {/* svg images */}
          <div className="coin">
            <svg xmlns="http://www.w3.org/2000/svg" width={34} height={77} xmlnsXlink="http://www.w3.org/1999/xlink" className="coin-tail">
              <use fill="url(#b1)" fillOpacity=".5" xlinkHref="#a1" transform="translate(.71 13.276)" />
              <use fill="url(#d1)" fillOpacity=".5" xlinkHref="#c1" transform="translate(8.86)" />
              <defs>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width={40} height={40} xmlnsXlink="http://www.w3.org/1999/xlink" className="coin-body">
              <g transform="translate(-1280 -149)">
                <use xlinkHref="#a" transform="translate(1281 150.828)" className="border-circle" />
                <mask id="b">
                  <path fill="#fff" d="M1280 149.828h40v40h-40z" />
                  <use xlinkHref="#a" transform="translate(1281 150.828)" />
                </mask>
                <use fill="#FFF" xlinkHref="#c" transform="translate(1281 150.828)" mask="url(#b)" />
              </g>
              <g transform="translate(-1280 -149)">
                <use xlinkHref="#d" transform="translate(1287 157)" className="inner-circle" />
                <mask id="e">
                  <path fill="#fff" d="M1286 156h28v27h-28z" />
                  <use xlinkHref="#d" transform="translate(1287 157)" />
                </mask>
                <use fill="#FFF" fillOpacity=".6" xlinkHref="#f" transform="translate(1287 157)" mask="url(#e)" />
              </g>
              <use fill="#FFF" xlinkHref="#g" transform="translate(16 15)" />
              <defs>
          ...
          <div className="bet-difference">
              + {toPrettyNumber(this.props.profit)} BTC
          </div>
